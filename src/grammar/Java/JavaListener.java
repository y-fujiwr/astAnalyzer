...
public interface JavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#block2}.
	 * @param ctx the parse tree
	 */
	void enterBlock2(JavaParser.Block2Context ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#block2}.
	 * @param ctx the parse tree
	 */
	void exitBlock2(JavaParser.Block2Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#statement2}.
	 * @param ctx the parse tree
	 */
	void enterStatement2(JavaParser.Statement2Context ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#statement2}.
	 * @param ctx the parse tree
	 */
	void exitStatement2(JavaParser.Statement2Context ctx);
	/**
